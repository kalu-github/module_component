...
public final class Consts {
    ...
    public static final String PAGENAME = "com.kalu.router";

    public static final String EXTRA_NAME = "router.kalu.annotation.Extra";
    ...
    public static final String Service = "router.kalu.core.interfaces.IService";

    public static final String ROUTEGROUP = "router.kalu.core.interfaces.IRouteGroup";

    public static final String ROUTEROOT = "router.kalu.core.interfaces.IRouteRoot";

    public static final String Extra = "router.kalu.core.interfaces.IExtra";

    public static final String GROUP_CLASS_NAME = "Annotation$$";

    public static final String ROOT_CLASS_NAME = "RouterManager$$Root$$";
    ...
    public static final ClassName ROUTER = ClassName.get("router.kalu.core.core", "RouterManager");
}
