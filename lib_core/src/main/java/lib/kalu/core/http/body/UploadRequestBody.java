 ...
 * created by kalu on 2017/5/12 14:34
 */
public class UploadRequestBody<T> extends RequestBody {

    private RequestBody mRequestBody;
    private OnUpLoadChangeListener<T> fileUploadObserver;

    public UploadRequestBody(File file, OnUpLoadChangeListener<T> fileUploadObserver) {
